// SPDX-License-Identifier: MIT
    ...
    contract PruCollection is ERC721Enumerable, Ownable {
         ...
         */
        constructor (string memory baseURI) ERC721("PruCollection", "PCOL") {
        ...
        */
        function mint() public payable onlyWhenNotPaused {
            require(tokenIds < maxTokenIds, "Exceed maximum PruCollection supply");
